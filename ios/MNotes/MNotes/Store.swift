...
enum ProductID {
    static let plusYearly = "de.mnotes.app.plus.yearly"
    static let plusLifetime = "de.mnotes.app.plus.lifetime"
    static let proYearly = "de.mnotes.app.pro.yearly"
    static let proMonthly = "de.mnotes.app.pro.monthly"
